...
\
		...
		{\
			...
			res = read(gear_comm_fd, lex_vars.comm_buf, COMM_BUF_SIZE);\
...
"CORE_HALT"		{ return CORE_HALT_KW; }
"CORE_INSN_STEP"	{ return CORE_INSN_STEP_KW; }
